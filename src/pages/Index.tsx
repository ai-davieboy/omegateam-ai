          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center -mb-10">
              <img 
                ...
                className="max-w-[60%] h-auto rounded-lg relative z-10"
              />
            </div>
            
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-orbitron relative z-20">
              Ready to <span className="text-neon animate-glow-pulse">Transform</span> Your Outreach?
            </h2>
            <p className="text-xl text-gray-300 mb-8 font-titillium relative z-20">
